...
<meta name="analytics-location" content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" />
  ...
  <meta class="js-ga-set" name="userId" content="a9b14d2867e45f72d0f6e9af961d0a14" %>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
  ...
  <meta name="html-safe-nonce" content="ee4730fd00168b8a1d8193364321692e9f416dd2">
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:27975320" href="/notifications">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@BUGLESPIDER" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/27975320?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          <li class="dropdown-header header-nav-current-user css-truncate">
            Signed in as <strong class="css-truncate-target">BUGLESPIDER</strong>
          </li>
          <li class="dropdown-divider"></li>
          <li><a role="menuitem" class="dropdown-item" href="/BUGLESPIDER" data-ga-click="Header, go to profile, text:your profile">Your profile</a></li>
          <li><a role="menuitem" class="dropdown-item" href="/BUGLESPIDER?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">Your stars</a></li>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <div id="readme" class="readme blob instapaper_body">
    <article class="markdown-body entry-content" itemprop="text"><h1><a id="user-content-lazymap---auto-nmap-scanning-script" class="anchor" aria-hidden="true" href="#lazymap---auto-nmap-scanning-script"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg>Warning:</h1>
<p>This is a heavily modified version of the original LazyMap script, please be careful that this does what you want, and to read the preamble notes thoroughly in:</p>
<p>lazymap.sh</p>
<p></p>
</a>Warning:</h1>
<p>This is a heavily modified version of the original LazyMap script, please be careful that this does what you want, and to read the preamble notes thoroughly in:</p>
<p>lazymap.sh</p>
<h1>LazyMap - Auto NMAP Scanning Script</h1>
...
<p><a href="https://github.com/nccgroup/port-scan-automation">https://github.com/nccgroup/port-scan-automation</a></p>
<p>Released under AGPL see LICENSE for more information</p>
...
<pre><code>git clone https://github.com/nccgroup/port-scan-automation.git
</code></pre>
...
<ul>
<li>
<p>Discovers live devices</p>
</li>
<li>
<p>Auto launches port scans on only the discoverd live devices</p>
</li>
<li>
<p>Can run mulitple instances on multiple adaptors at once</p>
</li>
<li>
<p>Creates client Ref directory for each scan</p>
</li>
<li>
<p>Outputs all unique open ports in a Nessus ready format. Much faster to scan in Nessus.</p>
</li>
<li>
<p>Runs as default a T4 speed scan. If you find this too slow, you can press CTRL C in the scan window and it will cleanup and relaunch that one scan with T5 speed option.</p>
</li>
<li>
<p>Logs all start/stop times, live hosts, hosts down, unique ports.</p>
</li>
<li>
<p>Auto creates a custom Nessus policy with only the discovered ports, must faster to scan. *</p>
</li>
<li>
<ul>
<li>Read the script header carefully, in order for the auto Nessus policy creater you must first save a default template to the same directory as the script. The script will detect the default template and create you a unique Nessus policy after each scan for just the unique ports. Then simply import the policy into Nessus and scan just the live devices that the  script found. This will save a massive amount of time scanning, plus will give you more accurate findings.</li>
</ul>
</li>
<li>
<ul>
<li>By Default it will scan a full TCP, Quick UDP, Common ports and a Safe Script scan. You can turn these on and off in the header.</li>
</ul>
</li>
</ul>
...
<ul>
<li>NMAP <a href="http://www.nmap.org" rel="nofollow">http://www.nmap.org</a></li>
</ul>
<p>Tested on Backtrack 5 and Kali.</p>
<h1><a id="user-content-screen-shot" class="anchor" aria-hidden="true" href="#screen-shot"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Screen Shot</h1>
<p><a target="_blank" href="https://camo.githubusercontent.com/6188d3f25fedbd5b11e3ccfec6be035667227ad7/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f70696e672e706e67"><img src="https://camo.githubusercontent.com/6188d3f25fedbd5b11e3ccfec6be035667227ad7/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f70696e672e706e67" alt="Screenshot" data-canonical-src="http://www.commonexploits.com/wp-content/uploads/2012/12/ping.png" style="max-width:100%;"></a></p>
<p><a target="_blank" href="https://camo.githubusercontent.com/558d20eb4549700afe352dced0d1fd7137b12756/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f7363616e732e706e67"><img src="https://camo.githubusercontent.com/558d20eb4549700afe352dced0d1fd7137b12756/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f7363616e732e706e67" alt="Screenshot" data-canonical-src="http://www.commonexploits.com/wp-content/uploads/2012/12/scans.png" style="max-width:100%;"></a></p>
<p><a target="_blank" href="https://camo.githubusercontent.com/6b7e12e47992cf5f1bc931c5645f9825f087fab8/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f756e697175652e706e67"><img src="https://camo.githubusercontent.com/6b7e12e47992cf5f1bc931c5645f9825f087fab8/687474703a2f2f7777772e636f6d6d6f6e6578706c6f6974732e636f6d2f77702d636f6e74656e742f75706c6f6164732f323031322f31322f756e697175652e706e67" alt="Screenshot" data-canonical-src="http://www.commonexploits.com/wp-content/uploads/2012/12/unique.png" style="max-width:100%;"></a></p>
<h1><a id="user-content-change-log" class="anchor" aria-hidden="true" href="#change-log"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Change Log</h1>
<p>Version 1.8 - Official release.</p>
</article>
  </div>
